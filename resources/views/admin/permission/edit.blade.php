    ...
    <div class="modal-content border pt-4 border-solid bg-gba-light rounded">
        <div class="modal-header">
            ...
            <a href="{{ route('permission.index') }}"
                class="btn btn-icon btn-sm btn-active-icon-primary p-2"><i class="ki-duotone ki-exit-left fs-3x">
            ...
            <form method="POST" action="{{ route('permission.update', $permission->id) }}" class="form"
                ...
                <div class="fv-row mb-7">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name', $permission->name) }}"
                        class="form-control form-control-solid" placeholder="Enter a permission name" />
                </div>
