                ...
                <div class="modal-content">
                  <div class="modal-header">
                      <h1 class="fw-bold">{{ __('Update role') }}</h1>
                      @if ($errors->any())
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td>
                                                              <label class="form-check form-check-custom form-check-solid me-9">
                                                                  <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" {{ in_array($permission->id, $roleHasPermissions) ? 'checked' : '' }} class="form-check-input">
