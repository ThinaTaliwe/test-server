...
.styled-checkbox + .styled-checkbox-label {
    ...
    margin-top: 5px; /* Add margin to separate from the label above */
}
...
.styled-checkbox:checked + .styled-checkbox-label:hover {
    background-color: #5cb85c; /* Lighter green for hover effect when checked */
...
@section('row_content')
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <div class="position-relative d-flex align-items-center my-1 mb-2 mb-md-0">
                        ...
                        <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Employees"/>
                    </div>
                </div>
    ...
    <!--end::Menu 1-->    <!--end::Filter-->
        ...
        <!--begin::Add customer-->
        <button type="button" class="btn btn-dark"  data-bs-toggle="modal" data-bs-target="#record_employee_modal" >
    ...
    <!--end::Toolbar-->
            ...
            <table id="employees" class="table border rounded table-row-dashed fs-6 g-5 gs-5" style="width:100%; background-color: #ffffff">
                <thead>
                    ...
                    @foreach ($employees as $employee)
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                <button class="btn btn-sm btn-primary btn-edit me-2" data-employee-id="{{ $employee->id }}">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content" style="background-color: #448C74">
                <div class="modal-header">
                    <h3 class="modal-title text-white" id="employeeModalTitle">Record Employee</h3>
                ...
                <form id="storeEmployee" method="POST" action="{{ route('employee.store') }}">
                    ...
                    <div class="modal-body">
                        <div class="pt-4 p-3">
                            <h4 class="text-white mb-3">Details of Employee:</h4>
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="person_id" class="form-label text-white">Person</label>
                                    <select class="form-select bg-light text-dark" id="person_id" name="person_id" style="width: 100%;">
                                        <option></option> <!-- Empty option for the placeholder -->
                                        @foreach ($persons as $person)
                                        <option value="{{ $person->id }}" data-first-name="{{ $person->first_name }}" data-last-name="{{ $person->last_name }}">
                                            {{ $person->first_name }} - {{ $person->initials }} - {{ $person->last_name }} - {{ $person->birth_date ?? 'No DOB' }} - {{ $person->id_number ?? 'No ID#' }}
                                        </option>
                                    @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="employee_first_name" class="form-label text-white">First Name</label>
                                    <input type="text" class="form-control bg-light text-dark" id="employee_first_name" name="first_name">
                                </div>
                                <div class="col">
                                    <label for="employee_last_name" class="form-label text-white">Last Name</label>
                                    <input type="text" class="form-control bg-light text-dark" id="employee_last_name" name="last_name">
                                </div>
                                <div class="col">
                                    <label for="call_name" class="form-label text-white">Call Name</label>
                                    <input type="text" class="form-control bg-light text-dark" id="call_name" name="call_name">
                                </div>
                                <div class="col">
                                    <label for="emp_number" class="form-label text-white">Employee Number</label>
                                    <input type="text" class="form-control bg-light text-dark" id="emp_number" name="emp_number">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="bu_id" class="form-label text-white">Business Unit</label>
                                    <select class="form-select bg-light text-dark" id="bu_id" name="bu_id" style="width: 100%;">
                                ...
                                <div class="col">
                                    <label for="employment_type_id" class="form-label text-white">Employment Type</label>
                                    <select class="form-select bg-light text-dark" id="employment_type_id" name="employment_type_id" style="width: 100%;">
                                ...
                                <div class="col">
                                    ...
                                    <input type="datetime-local" class="form-control bg-light text-dark" id="start_date" name="start_date">
                                </div>
                                <div class="col">
                                    <label for="end_date" class="form-label text-white">End Date</label>
                                    <input type="datetime-local" class="form-control bg-light text-dark" id="end_date" name="end_date">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="job_description_id" class="form-label text-white">Job Description</label>
                                    <select class="form-select bg-light text-dark" id="job_description_id" name="job_description_id" style="width: 100%;">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <select class="form-select bg-light text-dark" id="role_id" name="role_id" style="width: 100%;">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="company_id" class="form-label text-white">Company</label>
                                    <select class="form-select bg-light text-dark" id="company_id" name="company_id" style="width: 100%;">
                                ...
                                <div class="col d-flex flex-column align-items-center">
                                    <label for="shiftwork" class="form-label text-white">Shiftwork?</label>
                                ...
                                <div class="col">
                                    <label for="standard_starttime" class="form-label text-white">Standard Start Time</label>
                                    <input type="time" class="form-control bg-light text-dark" id="standard_starttime" name="standard_starttime">
                                </div>
                                <div class="col">
                                    <label for="standard_endtime" class="form-label text-white">Standard End Time</label>
                                    <input type="time" class="form-control bg-light text-dark" id="standard_endtime" name="standard_endtime">
                                </div>
                            </div>
...
<div class="modal fade" tabindex="-1" id="add_person_modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background-color: #448C74">
            <div class="modal-header">
                <h3 class="modal-title text-white">Add New Person</h3>
                <div class="btn btn-dark btn-icon btn-sm btn-active-light-dark ms-2" data-bs-dismiss="modal" aria-label="Close">
                    <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                </div>
            </div>
            <form id="addPersonForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="first_name_add" class="text-white">First Name</label>
                        <input type="text" class="form-control bg-light text-dark" id="first_name_add" name="first_name" required>
                    </div>
                    <div class="form-group">
                        <label for="initials" class="text-white">Initials</label>
                        <input type="text" class="form-control bg-light text-dark" id="initials" name="initials">
                    </div>
                    <div class="form-group">
                        <label for="last_name_add" class="text-white">Last Name</label>
                        <input type="text" class="form-control bg-light text-dark" id="last_name_add" name="last_name" required>
                    </div>
                    <div class="form-group">
                        <label for="screen_name" class="text-white">Screen Name</label>
                        <input type="text" class="form-control bg-light text-dark" id="screen_name" name="screen_name">
                    </div>
                    <div class="form-group">
                        <label for="id_number" class="text-white">ID Number</label>
                        <input type="text" class="form-control bg-light text-dark" id="id_number" name="id_number">
                    </div>
                    <div class="form-group">
                        <label for="birth_date" class="text-white">Birth Date</label>
                        <input type="date" class="form-control bg-light text-dark" id="birth_date" name="birth_date">
                    </div>
                    {{-- <div class="form-group">
                        <label for="marriage_status_id" class="text-white">Marital Status</label>
                    ...
                    <div class="form-group">
                        <label for="gender_id" class="text-white">Gender</label>
                    ...
                    <div class="form-group">
                        <label for="residence_country_id" class="text-white">Residence Country</label>
                        <select class="form-select bg-light text-dark" id="residence_country_id" name="residence_country_id">
                ...
                button.addEventListener('click', function() {
                    ...
                    fetch(`/admin/employee/${employeeId}/edit`)
                        ...
                        .then(data => {
                            ...
                            form.querySelector('select[name="company_id"]').value = data.company_id;
                            form.querySelector('input[name="shiftwork"]').checked = data.shiftwork;
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const employeeModal = new bootstrap.Modal(document.getElementById('record_employee_modal'), { focus: false });
        const personModal = new bootstrap.Modal(document.getElementById('add_person_modal'), { focus: false });
        ...
        $('#person_id').select2({
            ...
            if (!document.getElementById('add-new-person-btn')) {
                let buttonHtml = '<div class="select2-add-button-container" style="text-align: center; padding: 10px;">' +
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        var newOption = new Option(newPerson.first_name + ' - ' + newPerson.initials + ' - ' + newPerson.last_name + ' - ' + newPerson.birth_date + ' - ' + newPerson.id_number, newPerson.id, false, true);
                        $('#person_id').append(newOption).trigger('change');
                        $('#employee_first_name').val(newPerson.first_name); // Populate the first name field
                        $('#employee_last_name').val(newPerson.last_name); // Populate the last name field
                        personModal.hide();
                        employeeModal.show();
                    }
                },
