...
@section('row_content')
            ...
            <div class="d-flex flex-stack flex-wrap mb-5">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <div class="position-relative d-flex align-items-center my-1 mb-2 mb-md-0">
                        ...
                        <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Employee Roles"/>
                    </div>
                </div>
    ...
    <!--end::Menu 1-->    <!--end::Filter-->
        ...
        <!--begin::Add customer-->
        <button type="button" class="btn btn-light"  data-bs-toggle="modal" data-bs-target="#record_role_modal" >
    ...
    <!--end::Toolbar-->
            ...
            <!--end::Wrapper-->
            <table id="roles" class="table border rounded table-row-dashed fs-6 g-5 gs-5" style="width:100%; background-color: #ffffff">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-primary btn-edit" data-role-id="{{ $role->id }}">Edit</button>
                            <form action="{{ route('employeerole.destroy', $role->id) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
        ...
        button.addEventListener('click', function() {
            ...
            fetch(`/admin/employeerole/${roleId}/edit`)
                ...
                .then(data => {
                    ...
                    modal.querySelector('form').setAttribute('action', `/admin/employeerole/${roleId}`);
                    
                    // Add PUT method
                    modal.querySelector('form').insertAdjacentHTML('beforeend', '<input type="hidden" name="_method" value="PUT">');

                    modal.querySelector('input[name="employee_role_name"]').value = data.name;
                    modal.querySelector('input[name="employee_role_description"]').value = data.description;
