        ...
        <div class="card-body">
            ...
            <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
                ...
                <div class="multisteps-form__progress stepper-nav mb-5">
                    <button class="multisteps-form__progress-btn js-active text-primary" type="button"
                        title="Personal Info">
                ...
                <label class="form-check-label mb-0 ms-3" for="EngAfr">English/Afrikaans</label>
                            ...
                            <div class="multisteps-form__content">
                                <div class="card-body g-3 px-4 pb-2 pt-3">
                                    ...
                                    <fieldset {{ $dis }} role="form" id="membershipForm" name="membershipForm"
                                        class="row g-3 ">
                                        @csrf
                   ...
                   <label for="inputAddress" class="form-label">Date Of Birth</label>
                                                ...
                                                <div class="input-group input-group-outline ">
                                                    ...
                                                    <input type="text" onkeypress="return isNumberKey(event)"
                                                        ...
                                                        value="{{ 02 }}" placeholder="DD" maxlength="2"
                                                        size="2">
                                                    {{-- @error('inputDay')
															<span class="invalid-feedback" role="alert">
															  <strong>{{ $message }}</strong>
                                                ...
                                                <div class="input-group input-group-outline ">
                                                    ...
                                                    <input type="text" onkeypress="return isNumberKey(event)"
                                                        ...
                                                        value="{{ 02 }}" placeholder="MM" maxlength="2"
                                                        size="2">
                                                    {{-- @error('inputMonth')
															<span class="invalid-feedback" role="alert">
															  <strong>{{ $message }}</strong>
                                                ...
                                                <div class="input-group input-group-outline ">
                                                    ...
                                                    <input type="text" onkeypress="return isNumberKey(event)"
                                                        ...
                                                        value="{{ 2000 }}" placeholder="YYYY" maxlength="4"
                                                        size="4">
                                                    {{-- @error('inputYear')
															<span class="invalid-feedback" role="alert">
															  <strong>{{ $message }}</strong>
                                                ...
                                                <div class="btn-group  col d-flex justify-content-center align-items-center mx-auto"
                                                    ...
                                                    {{-- 								
															<input type="radio" class="btn-check form-check-input" name="marital_status"
															  id="null" value="0" {{ ($membership->person->married_status=="null")? "checked" : "" }} />
                                        ...
                                        <div class="col-8 mx-auto">
                                            <div class="text-center  d-flex justify-content-center align-items-center ">
                                                <x-button type="submit" text="Update"
                                                    class="btn bg-gradient-success w-100 my-4 mb-4" id="btnUpdate"><i
                                ...
                                <div class="button-row d-flex mt-4">
                                    <x-button text="Next" id="btnNext"
                                        class="btn bg-primary ms-auto mb-0 js-btn-next" type="button"
                                        title="Next">Next</x-button>
                                </div>
                            </div>
                        ...
                        <div class="multisteps-form__panel border-radius-xl bg-bs-color" data-animation="FadeIn">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-6 col-sm-6 pt-3 mt-sm-0" style=" margin-top: 25px;">
                                                    <div
                                                        ...
                                                        <input type="radio" class="btn-check form-check-input"
                                                            name="radioGenderDep" id="MaleDep" value="M"
                                                            checked />
                                            ...
                                            <div class="row mt-0">
                                                <div class="col-12 col-sm-6">
                                                    <div
                                                        ...
                                                        <input hidden type="text" class="form-control"
                                                            name="mainMemberId" id="mainMemberId"
                                                ...
                                                <div class="col-6" style=" margin-top: 25px;">
                                                    <div
                                                        ...
                                                        <input type="radio" class="btn-check form-check-input"
                                                            name="radioRelationCode" id="Spouse" value="1"
                                                            checked />
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-6 mx-auto">
                                                    <div
                                                        ...
                                                        <x-button id="btnAdd" text="Add" type="submit"
                                                            class="bg-gradient-success w-100 my-4 mb-4"><i
                            ...
                            <div class="button-row d-flex mt-4">
                                <x-button id="btnPrev" class="bg-primary mb-0 js-btn-prev" type="button"
                                    title="Prev" text="Prev">Prev</x-button>
                                <x-button id="btnNext" class="bg-primary ms-auto mb-0 js-btn-next" type="button"
                                    title="Next" text="Next">Next</x-button>
                            </div>
                        </div>
                            ...
                            <div class="multisteps-form__content">
                                                        ...
                                                        <li
                                                            ...
                                                            <div class="ms-auto text-end">
                                                                <a class="btn btn-link text-success text-gradient px-3 mb-0"
                                                                    href="#"><i
                                                                        class="material-icons text-sm me-2">location_on</i>View
                                                                    On Map</a>
                                        ...
                                        <div class="card h-100 mb-4">
                                            ...
                                            <div class="card-body pt-4 p-3">
                                                ...
                                                <div class="button-row d-flex mt-4">
                                                    ...
                                                    <x-button id="btnAddAddr"
                                                        class="btn bg-gradient-success mx-auto mb-0 w-100" type="button"
                                ...
                                <div class="row">
                                    <div class="button-row d-flex mt-4 col-12">
                                        <x-button id="btnPrev" class="bg-primary mb-0 js-btn-prev" type="button"
                                            title="Prev" text="Prev">Prev</x-button>
                                        <x-button id="btnNext" class="bg-primary ms-auto mb-0 js-btn-next"
                                            type="button" title="Next" text="Next">Next</x-button>
                                    </div>
                                </div>
                            </div>
                        </div>
