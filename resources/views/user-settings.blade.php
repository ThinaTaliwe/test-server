...
@push('scripts')
		...
		am5.ready(function () {
			...
			var pretoria = addCity({ latitude: -25.7479, longitude: 28.2293 }, "Pretoria");
var capeTown = addCity({ latitude: -33.9249, longitude: 18.4241 }, "Cape Town");
var durban = addCity({ latitude: -29.8587, longitude: 31.0218 }, "Durban");
var kimberley = addCity({ latitude: -28.7323, longitude: 24.7623 }, "Kimberley");
