                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card" style="border: gray solid 2px;">
                            <div class="card-header"><h1 class="mt-5">Source Mappings</h1></div>
                    ...
                    <div class="col-md-6">
                        <div class="card" style="border: gray solid 2px;">
                            <div class="card-header"><h1 class="mt-5">Target Mappings</h1></div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const databases = {
                ...
                "1office_0_2": '1office',
                "SysproCompanyBA": 'sysproba',
                "SysproCompanyBF": 'sysprobf',
                "SysproCompanyNA": 'sysprona'
