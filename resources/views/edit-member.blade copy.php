            ...
            <div class="row">
                ...
                <div class="mt-4 mb-4 pb-4">
                    ...
                    <div class="card h-100 mb-4 bg-light rounded bg-secondary border border-gray-400">
                        ...
                        <form id="addAddress" method="POST" action="{{ route('address.store') }}" autocomplete="off">
                            @csrf
                            <div class="card-body pt-4 p-3">
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <div
                                            ...
                                            <input type="text" class="form-control bg-light text-dark" name="Line2"
                                                id="Line2" value="{{ old('Line2') }}" placeholder="Address Line 2"
                                                required>
                                        </div>
                                        @error('Line2')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <div
                                            ...
                                            <input type="text" class="form-control bg-light text-dark"
                                                ...
                                                placeholder="Town/Suburb" required>
                                        </div>
                                        @error('TownSuburb')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div
                                            ...
                                            <input type="text" class="form-control bg-light text-dark" name="City"
                                                id="City" value="{{ old('City') }}" placeholder="City" required>
                                        </div>
                                        @error('City')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-6 col-sm-4 mt-3 mt-sm-0">
                                        <div
                                            ...
                                            <input type="text" class="form-control bg-light text-dark" name="Province"
                                                id="Province" value="{{ old('Province') }}" placeholder="Province"
                                                required>
                                        </div>
                                        @error('Province')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-6 col-sm-4 mt-3 mt-sm-0 mx-auto">
                                        <div
                                            ...
                                            <input type="text" class="form-control bg-light text-dark" name="Country"
                                                id="Country" value="{{ old('Province') }}" placeholder="Country"
                                                required>
                                        </div>
                                        @error('Country')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <input hidden type="text" class="form-control" name="MembershipId" id="MembershipId"
                                    value="{{ $membership->id }}">

                                <div class="button-row d-flex mt-4">
                                    <button id="btnAddAddr" class="btn btn-success mx-auto mb-0 w-40" type="submit"
                                        title="Add New Address" text="Add"><i class="material-icons">add</i>Add
                                    </button>
                                </div>
                            </div>
                        </form>
                ...
                <div class="mt-2 text-center">
                    ...
                    <div class="tab-content mt-2" id="myTabContent">
                                    ...
                                    <form action="{{ route('update-member', $membership->id) }}" method="POST"
                                        ...
                                        <div class="col-4">
                                            <div class="form-floating mt-3 mb-0">
                                                ...
                                                <input type="text" class="form-control bg-light text-dark"
                                                    name="Name" id="Name" value="{{ $membership->name }}"
                                        ...
                                        <div class="col-4">
                                            <div class="form-floating  mt-3 mb-0">
                                                ...
                                                <input type="text" class="form-control bg-light text-dark"
                                                    name="Surname" id="Surname" value="{{ $membership->surname }}"
                                                    placeholder="" required>
                                                <label for="Surname" class="fs-4 text-gray-600">Surname<span
                                                        class="text-danger">*</span></label>
                                            </div>
                        ...
                        <div class="tab-pane fade" id="dependants">
                            ...
                            <div class="card-body rounded border-bottom">
                                <div class="table-responsive p-0">
                                    <h1>Dependants List</h1>
