                ...
                <div class="mt-2 text-center">
                    ...
                    <div class="tab-content mt-6" id="myTabContent">
                        <div class="tab-pane fade show active" id="membership">
                            ...
                            <div class="card-body g-3 rounded bg-gba-light">
                                <form action="{{ route('update-member', $membership->id) }}" method="POST"
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-outline  mt-3 mb-0">
                                            ...
                                            <input type="text" class="form-control bg-light text-dark" name="Name" id="Name"
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-outline  mt-3 mb-0">
                                            ...
                                            <input type="text" class="form-control bg-light text-dark" name="Surname" id="Surname"
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-outline   mt-3 mb-0">
                                            ...
                                            <input type="text" class="form-control bg-light text-dark" name="IDNumber" id="IDNumber"
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-outline mb-0 mt-1">
                                            ...
                                            <input type="email" class="form-control bg-light text-dark" name="Email" id="Email"
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-outline mb-0">
                                            ...
                                            <input type="number" class="form-control bg-light text-dark" name="Telephone" id="Telephone"
                                    ...
                                    <div class="col-4">
                                        <div class="input-group input-group-outline mb-0">
                                            ...
                                            <input type="number" class="form-control bg-light text-dark" name="WorkTelephone"
                                    ...
                                    <div class="col-3 d-flex align-items-center">
                                        ...
                                        <div class="input-group input-group-outline ">
                                            ...
                                            <input type="text" onkeypress="return isNumberKey(event)"
                                                class="form-control bg-light text-dark" name="inputDay" id="inputDay"
                                        ...
                                        <div class="input-group input-group-outline ">
                                            ...
                                            <input type="text" onkeypress="return isNumberKey(event)"
                                                class="form-control bg-light text-dark" name="inputMonth" id="inputMonth"
                                        ...
                                        <div class="input-group input-group-outline ">
                                            <input type="text" onkeypress="return isNumberKey(event)"
                                                class="form-control bg-light text-dark" name="inputYear" id="inputYear"
                                    ...
                                    <div class="col-2 pt-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select bg-light text-dark" name="radioGender" id="genderSelect">
                        ...
                        <div class="tab-pane fade" id="dependants">
                            ...
                            <div class="card-body bg-gba-light rounded border-bottom">
                            ...
                            <!-- Add Dependant Block -->
                            <div class="card mt-5 mb-2 bg-gba-light rounded" id="add-dependant">
                                         <div class="card-header bg-gba-light">
                                            <h1 class="text-center mx-auto my-auto text-light">Add Dependants</h1>
                                        </div>
                                ...
                                <form id="addDependant" method="POST" action="{{ route('add-dependant.store') }}"
                                    ...
                                    <div class="card-body bg-gba-light rounded">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div id="IDNumberDepDiv"
                                                    ...
                                                    <input type="text" class="form-control bg-light text-dark" name="IDNumberDep"
                                        ...
                                        <div class="row ">
                                            <div class="col-4">
                                                <div
                                                    ...
                                                    <div id="inputDayDepDiv"
                                                        ...
                                                        <input type="text" onkeypress="return isNumberKey(event)"
                                                            class="form-control bg-light text-dark" name="inputDayDep" id="inputDayDep"
                                                    ...
                                                    <div id="inputMonthDepDiv"
                                                        ...
                                                        <input type="text" onkeypress="return isNumberKey(event)"
                                                            class="form-control bg-light text-dark" name="inputMonthDep" id="inputMonthDep"
                                                    ...
                                                    <div id="inputYearDepDiv"
                                                        ...
                                                        <input type="text" onkeypress="return isNumberKey(event)"
                                                            class="form-control bg-light text-dark" name="inputYearDep" id="inputYearDep"
                                            ...
                                            <div class="col-4" style="margin-top: 15px; text-align: center;">
                                                ...
                                                <select class="form-select bg-light text-dark" name="radioGenderDep" id="genderDepSelect">
                        ...
                        <div class="tab-pane fade" id="addresses">
                            ...
                            <div class="row">
                                ...
                                <div class="mt-4 mb-4 pb-4">
                                    ...
                                    <div class="card h-100 mb-4 bg-gba-light rounded">
                                        <div class="card-header">
                                        <h1 class="text-center mx-auto my-auto text-light">Add New Address</h1>
                                        </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark" name="Line1"
                                                                id="Line1" value="{{ old('Line1') }}" placeholder="Address Line 1">
                                                        </div>
                                                        @error('Line1')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-6 col-sm-6">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark" name="Line2"
                                                    ...
                                                    <div class="col-6 col-sm-6">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark" name="TownSuburb"
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-12 col-sm-6">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark" name="City"
                                                    ...
                                                    <div class="col-6 col-sm-4 mt-3 mt-sm-0">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark" name="Province"
                                                    ...
                                                    <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark" name="PostalCode"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 col-sm-4 mt-3 mt-sm-0 mx-auto">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark" name="Country"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (activeTab && $('#myTabs a[href="' + activeTab + '"]').length > 0) {
                ...
                var firstTab = $('#myTabs a').first(); // Find the first tab
                firstTab.tab('show'); // Show the first tab if no active tab is saved or if it's invalid
                console.log("Defaulting to first tab: " + firstTab.attr('href')); // Debugging: log the default tab
            }
        });
    </script>
