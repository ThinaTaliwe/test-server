            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y pt-10 pb-15 px-lg-17">
                    ...
                    <div data-kt-element="options">
                        <!--begin::Notice-->
                        <p class="text-muted fs-5 fw-semibold mb-10">In addition to your username and password, you’ll
                        ...
                        <div class="pb-10">
                            ...
                            <label
                                ...
                                <span class="d-block fw-semibold text-start">
                                    ...
                                    <span class="text-muted fw-semibold fs-6">We will send a code via SMS if you need
                    ...
                    <div class="d-none" data-kt-element="sms">
                        ...
                        <!--end::Heading-->
                        <!--begin::Notice-->
                        <div class="text-muted fw-semibold mb-10">Enter your mobile phone number with country code and
