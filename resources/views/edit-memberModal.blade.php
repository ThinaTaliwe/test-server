                                    ...
                                    <form action="{{ route('update-member', $membership->id) }}" method="POST"
                                        ...
                                        <div class="col-4">
                                            <div class="form-floating  mt-3 mb-0">
                                                ...
                                                <input type="text" class="form-control bg-light text-dark" name="Surname"
                                                    id="Surname" value="{{ $membership->surname }}" placeholder="" required>
                                        ...
                                        <div class="col-3" style="margin-bottom: 1rem;">
                                            <div class="form-group" style="padding-top: 1rem; text-align: center;">
                                                ...
                                                <select class="form-select pb-3 bg-light text-dark" name="marital_status" id="maritalStatusSelect" required>
                                                <option value="">Select Marital Status</option>
                                                @foreach ($marriages as $status)
                                                    <option value="{{ $status->id }}"
                                            ...
                                            <div class="col-4">
                                                <div id="IDNumberDepDiv"
                                                    ...
                                                    <input type="text" class="form-control bg-light text-dark"
                                                        ...
                                                        maxlength="13" size="13" onchange="getDOBDep(this.value)" required>
                                                </div>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark"
                                                                name="Line1" id="Line1"
                                                                value="{{ old('Line1') }}" placeholder="Address Line 1" required>
                                                        </div>
                                                        @error('Line1')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-6 col-sm-6">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark"
                                                                name="Line2" id="Line2"
                                                                value="{{ old('Line2') }}" placeholder="Address Line 2" required>
                                                        </div>
                                                        @error('Line2')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                    ...
                                                    <div class="col-6 col-sm-4 mt-3 mt-sm-0 mx-auto">
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control bg-light text-dark"
                                                                ...
                                                                value="{{ old('Province') }}" placeholder="Country" required>
                                                        </div>
                                                        @error('Country')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
