...
@section('row_content')
    <!--begin::Card-->
    <div class="card rounded col-xxl-8 col-md-8 mb-xxl-10">
        <!--begin::Card body-->
        <div class="card-body">
            <!--begin::Stepper-->
                     ...
                     <label class="form-label">Date Of Birth</label>
                        ...
                        <div class="multisteps-form__panel border-radius-xl bg-bs-color h-100" data-animation="FadeIn">
                            ...
                            <div class="multisteps-form__content mt-3">
                                ...
                                <div class="button-row d-flex mt-4">
                                    <x-button class="btn bg-primary mb-0 js-btn-prev" type="button" title="Prev"
                                        id="btnPrev" text="Prev">Prev</x-button>
                                    <x-button class="btn bg-success ms-auto mb-0" type="submit" title="Add"
                                        id="kt_docs_sweetalert_basic" text="Add">Add</x-button>
                                </div>
                            </div>
                        </div>
                    </form>
