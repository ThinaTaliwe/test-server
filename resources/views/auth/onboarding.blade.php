        ...
        <div class="card" style="background-color: white;">
            <div class="card-body">
                <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
                    ...
                    <form class="mx-auto mw-600px w-100 pt-15 pb-10" action="{{ route('save-user-info', Auth::user()) }}" method="POST" novalidate="novalidate" id="kt_create_account_form">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="current" data-kt-stepper-element="content">
                            <div class="d-flex flex-column flex-center text-center p-10">
                                <div class="mb-7">
                                    <a href="#" class="">
                                        <img alt="Logo" src="{{ asset('img/GBA-LOGO-white.png') }}" class="h-90px logo ">
                                    </a>
                                </div>
                                ...
                                <div class="mb-0">
                                    <img src="{{ asset('img/Welcomeimg.png')}}" class="mw-100 mh-300px theme-light-show" alt="" />
                                    <img src="{{ asset('img/Welcomeimg.png')}}" class="mw-100 mh-300px theme-dark-show" alt="" />
                                </div>
                                <div class="mb-0">
                                    <div class="fw-semibold fs-8 text-gray-500 mb-7">
                                        Powered By
                                    </div>
                                    <img alt="1officeLogo" src="{{ asset('img/1-OFFICE LOGO.png') }}" class="h-50px logo ">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="row mb-10">
                                    <div class="col-md-6">
                                        ...
                                        <input name="first_name" class="form-control form-control-lg form-control-solid" value="{{ old('first_name') }}" required />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label required">Last Name</label>
                                        <input name="last_name" class="form-control form-control-lg form-control-solid" value="{{ old('last_name') }}" required />
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    <div class="col-md-6">
                                        <label class="form-label required">Initials</label>
                                        <input name="initials" class="form-control form-control-lg form-control-solid" value="{{ old('initials') }}" required />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label required">Screen Name</label>
                                        <input name="screen_name" class="form-control form-control-lg form-control-solid" value="{{ old('screen_name') }}" required />
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    <div class="col-md-6">
                                        <label class="form-label required">ID Number</label>
                                        <input name="id_number" class="form-control form-control-lg form-control-solid" value="{{ old('id_number') }}" required />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label required">Birth Date</label>
                                        <input type="date" name="birth_date" class="form-control form-control-lg form-control-solid" value="{{ old('birth_date') }}" required />
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    <div class="col-md-6">
                                        <label class="form-label required">Married Status</label>
                                        <select name="married_status" class="form-select form-select-lg form-select-solid select2-married-status" required>
                                            <option disabled selected value="">Select...</option>
                                            @foreach($marriedStatuses as $status)
                                            <option value="{{ $status->id }}" {{ old('married_status') == $status->id ? 'selected' : '' }}>{{ $status->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    <div class="col-md-6">
                                        ...
                                        <select name="gender_id" class="form-select form-select-lg form-select-solid select2-gender" required>
                                            <option disabled selected value="">Select...</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="residence_country_id" class="form-select form-select-lg form-select-solid select2-country" required>
                                            <option disabled selected value="">Select...</option>
                                            @foreach($countries as $country)
                                            <option value="{{ $country->id }}" {{ old('residence_country_id') == $country->id ? 'selected' : '' }}>{{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            <div class="input-group input-group-outline @error('Line1') is-invalid focused is-focused @enderror mb-0">
                                                <input type="text" class="form-control" name="Line1" id="Line1" value="{{ old('Line1') }}" placeholder="Address Line 1">
                                            </div>
                                            @error('Line1')
                        ...
                        <div class="d-flex flex-stack pt-15">
                            ...
                            <div>
                                ...
                                <button type="button" class="btn btn-lg btn-primary" data-kt-stepper-action="next" id="btn-next">
                                    Continue
