            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                ...
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <!--begin::Title-->
                        <h1>You are <span>authorized access</span> to this page.</h1>
                        <!--end::Title-->
                        <!--begin::Link-->
                        <div class="mb-11">
                            <br>
                        ...
                        <!--begin::Action-->
                        <div class="fs-6 mb-8">
                            <span class="fw-semibold text-gray-500">Not interested?</span>
                            <a onclick="goBack()" class="link-primary fw-bold">Go Back!</a>
                        </div>
                        <!--end::Action-->
