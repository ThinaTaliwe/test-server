        ...
        <div class="card-body">
            ...
            <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
                ...
                <div class="multisteps-form__progress stepper-nav mb-5">
                    <button class="multisteps-form__progress-btn js-active text-primary fs-5" type="button"
                        title="Personal Info">Person Info</button>
                    <button class="multisteps-form__progress-btn text-primary fs-5" type="button"
                        title="Address">Address</button>
                    <button class="multisteps-form__progress-btn text-primary fs-5" type="button"
                        title="Contact Info">Contact Info</button>
                    <button class="multisteps-form__progress-btn text-primary fs-5" type="button"
                        title="Membership Type">Membership Type</button>
                </div>
                <!--end::Nav-->
                <!--begin::Form-->
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12 col-sm-6 mx-auto pe-7 mt-sm-0 ">
                                        <div
                                            ...
                                            <div class="btn-group rounded-top border-top" role="group"
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div id="IDNumber"
                                            ...
                                            <input type="text" class="multisteps-form__input form-control"
                                                name="IDNumber" id="IDNumber" value="{{ old('IDNumber') }}"
                 ...
                 <label class="form-label">Date Of Birth</label>
                                            ...
                                            <div id="inputDayDiv"
                                                ...
                                                <input type="text" onkeypress="return isNumberKey(event)"
                                                    class="multisteps-form__input form-control" name="inputDay"
                                                    id="inputDay" value="{{ old('inputDay') }}" placeholder="DD"
                                                    maxlength="2" size="2">
                                                @error('inputDay')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div id="inputMonthDiv"
                                                ...
                                                <input type="text" onkeypress="return isNumberKey(event)"
                                                    class="multisteps-form__input form-control" name="inputMonth"
                                                    id="inputMonth" value="{{ old('inputMonth') }}" placeholder="MM"
                                                    maxlength="2" size="2">
                                            ...
                                            <div id="inputYearDiv"
                                                ...
                                                <input type="text" onkeypress="return isNumberKey(event)"
                                                    class="multisteps-form__input form-control" name="inputYear"
                                                    id="inputYear" value="{{ old('inputYear') }}" placeholder="YYYY"
                                                    maxlength="4" size="4">
                                                @error('inputYear')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class=" pb-2 ">
											...
											">
                                                <input type="radio" class="btn-check form-check-input"
                                                    name="marital_status" id="Married" value="1" checked />
                                ...
                                <div class="button-row d-flex mt-4">
                                    <x-button id="btnNext" class="btn bg-primary ms-auto mb-0 js-btn-next"
                                        type="button" text="Next" title="Next">Next</x-button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="multisteps-form__panel border-radius-xl bg-bs-color" data-animation="FadeIn">
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        <div
                                            ...
                                            <input type="text" class="multisteps-form__input form-control"
                                                name="Line1" id="Line1" value="{{ old('Line1') }}">
                                        </div>
                                        @error('Line1')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row mt-3">
                                    <div class="col-6 col-sm-6">
                                        <div
                                            ...
                                            <input type="text" class="multisteps-form__input form-control"
                                                name="Line2" id="Line2" value="{{ old('Line2') }}"
                                    ...
                                    <div class="col-6 col-sm-6">
                                        <div
                                            ...
                                            <input type="text" autocomplete="off"
                                                class="multisteps-form__input form-control" name="TownSuburb"
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                                        <div
                                            ...
                                            <input type="text" class="multisteps-form__input form-control"
                                                name="PostalCode" id="PostalCode" value="{{ old('PostalCode') }}"
                            ...
                            <div class="button-row d-flex mt-4">
                                <x-button class="btn bg-primary mb-0 js-btn-prev" type="button" title="Prev"
                                    text="Prev" id="btnPrev">Prev</x-button>
                                <x-button class="btn bg-primary ms-auto mb-0 js-btn-next" type="button" title="Next"
                                    id="btnNext" text="Next">Next</x-button>
                            </div>
                        </div>
                            ...
                            <div class="multisteps-form__content">
                                    ...
                                    <div class="col-12">
                                        <div
                                            ...
                                            <input type="number" class="form-control" name="Telephone" id="Telephone"
                                                value="{{ old('Telephone') }}" placeholder="Telephone (Cell)"
                                                maxlength="10">
                                        </div>
                                        @error('Telephone')
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="row">
                                    <div class="button-row d-flex mt-4 col-12">
                                        <button class="btn bg-primary mb-0 js-btn-prev" type="button"
                        ...
                        <div class="multisteps-form__panel border-radius-xl bg-bs-color h-100" data-animation="FadeIn">
                            ...
                            <div class="multisteps-form__content mt-3">
                                            ...
                                            <select id="memtype" name="memtype"
                                                ...
                                                @foreach ($memtypes as $memtype)
                                                    ...
                                                    @if (old('memtype') == $memtype->id)
                                                        <option value="{{ $memtype->id }}" selected>{{ $memtype->id }}.
                                ...
                                <div class="button-row d-flex mt-4">
                                    <x-button class="btn bg-primary mb-0 js-btn-prev" type="button" title="Prev" id="btnPrev" text="Prev">Prev</x-button>
                                    <x-button class="btn bg-success ms-auto mb-0" type="submit" title="Add" id="kt_docs_sweetalert_basic" text="Add">Add</x-button>
                                </div>
                            </div>
                        </div>
                    </form>
