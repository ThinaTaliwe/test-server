...
@section('row_content')
    <!--begin::Card-->
    <div class="card rounded mb-xxl-10">
        <!--begin::Card body-->
        <div class="card-body">
            <!--begin::Stepper-->
            <div class="stepper stepper-links d-flex flex-column pt-15">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('add-member.store') }}" class="multisteps-form__form"
                        autocomplete="off">
                        @csrf
                        <div class="multisteps-form__panel border-radius-xl js-active" data-animation="FadeIn">
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="dropdown">
                                            <select id="memtype" name="memtype"
                                                class="btn btn-primary shadow-dark dropdown-toggle w-100 my-4 @error('memtype') is-invalid @enderror"
